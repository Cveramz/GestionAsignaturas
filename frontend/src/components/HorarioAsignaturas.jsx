...
import { Grid, Paper, Typography, Table, TableContainer, TableHead, TableRow, TableCell, TableBody, Button, Alert, AlertTitle } from '@mui/material';
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:8080/horarios/asignatura/${id}`)
            .then(response => {
                ...
                // Mostrar la alerta si no hay bloques
                setAlertaVisible(response.data.length === 0);
            })
            .catch(error => {
        ...
        <div>
            ...
            {alertaVisible && (
                <Alert severity="error" style={{ marginBottom: '10px' }}>
                    ...
                    No existe un horario registrado.
                </Alert>
            )}
